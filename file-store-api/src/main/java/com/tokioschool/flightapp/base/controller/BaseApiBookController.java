package com.tokioschool.flightapp.base.controller;

import com.tokioschool.flightapp.base.dto.*;
import com.tokioschool.flightapp.base.service.BookService;
...
public class BaseApiBookController {
  ...
  public ResponseEntity<PageDTO<BookDTO>> searchBooks(
      ...
      @Min(1) @Max(100) @RequestParam(value = "page_size", required = false, defaultValue = "10")
          int pageSize) {

    PageDTO<BookDTO> pageDTO =
